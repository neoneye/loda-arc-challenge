...
;mov $40,-1 ; TODO: the replace destination color
mov $40,0 ; the replace destination color
...
;  f11 $0,101160 ; trim
;  
;  f21 $0,101100 ; noise color
;
;  ; TODO: determine what the pixel is in the output image
;  ;max $40,$0
;
;  ; next iteration
